-- Insert dummy users
INSERT INTO users (username, email, password_hash, image, bio, role, created_at) VALUES
('john_doe', 'john@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iKyVqjJ8K8K8K8K8K8K8K8K8K8K8K', 'uploads/avatar1.jpg', 'Software developer passionate about clean code', 'USER', NOW()),
('jane_smith', 'jane@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iKyVqjJ8K8K8K8K8K8K8K8K8K8K8K', 'uploads/avatar2.jpg', 'Full-stack developer and tech blogger', 'USER', NOW()),
('mike_wilson', 'mike@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iKyVqjJ8K8K8K8K8K8K8K8K8K8K8K', 'uploads/avatar3.jpg', 'DevOps engineer and cloud enthusiast', 'USER', NOW()),
('sarah_jones', 'sarah@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iKyVqjJ8K8K8K8K8K8K8K8K8K8K8K', 'uploads/avatar4.jpg', 'UI/UX designer with a passion for accessibility', 'USER', NOW()),
('alex_brown', 'alex@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iKyVqjJ8K8K8K8K8K8K8K8K8K8K8K', 'uploads/avatar5.jpg', 'Data scientist and machine learning researcher', 'USER', NOW()),
('admin_user', 'admin@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iKyVqjJ8K8K8K8K8K8K8K8K8K8K8K', 'uploads/admin.jpg', 'System administrator', 'ADMIN', NOW());

-- Insert dummy posts
INSERT INTO posts (creator_id, title, content, media_url, media_type, tags, created_at) VALUES
(1, 'Getting Started with React Hooks', 'React Hooks revolutionized how we write functional components. In this post, I''ll walk you through the most commonly used hooks and how to implement them effectively...', 'uploads/react-hooks.jpg', 'IMAGE', ARRAY['react', 'javascript', 'webdev', 'tutorial'], NOW() - INTERVAL '2 days'),
(2, 'Building Scalable Microservices', 'Microservices architecture has become the go-to solution for large-scale applications. Here are the key principles and patterns you need to know...', 'uploads/microservices.jpg', 'IMAGE', ARRAY['microservices', 'architecture', 'backend', 'scalability'], NOW() - INTERVAL '1 day'),
(3, 'Docker Best Practices', 'After working with Docker for several years, I''ve learned some valuable lessons. Here are the best practices that will save you time and headaches...', 'uploads/docker.jpg', 'IMAGE', ARRAY['docker', 'devops', 'containers', 'best-practices'], NOW() - INTERVAL '3 days'),
(4, 'Design Systems: A Complete Guide', 'Design systems are essential for maintaining consistency across large applications. Let me share my experience building and maintaining design systems...', 'uploads/design-system.jpg', 'IMAGE', ARRAY['design', 'ui', 'ux', 'design-systems'], NOW() - INTERVAL '4 days'),
(5, 'Machine Learning with Python', 'Python has become the de facto language for machine learning. In this comprehensive guide, I''ll show you how to get started with popular ML libraries...', 'uploads/ml-python.jpg', 'IMAGE', ARRAY['python', 'machine-learning', 'data-science', 'tutorial'], NOW() - INTERVAL '5 days'),
(1, 'TypeScript Tips and Tricks', 'TypeScript can be tricky at first, but once you master these patterns, you''ll wonder how you ever lived without it. Here are my favorite TypeScript tips...', 'uploads/typescript.jpg', 'IMAGE', ARRAY['typescript', 'javascript', 'webdev', 'tips'], NOW() - INTERVAL '6 days'),
(2, 'API Design Principles', 'Good API design is crucial for developer experience. Here are the principles I follow when designing RESTful APIs...', 'uploads/api-design.jpg', 'IMAGE', ARRAY['api', 'rest', 'backend', 'design'], NOW() - INTERVAL '7 days'),
(3, 'Kubernetes for Beginners', 'Kubernetes can seem overwhelming at first, but it''s actually quite logical once you understand the core concepts. Let me break it down for you...', 'uploads/kubernetes.jpg', 'IMAGE', ARRAY['kubernetes', 'devops', 'containers', 'beginners'], NOW() - INTERVAL '8 days');
