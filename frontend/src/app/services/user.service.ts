...
export class UserService {
    ...
    private checkAuthStatus(): Observable<User | null> {
        return this.http.get<User>(`${this.API_URL}/auth/me`, { withCredentials: true })
            .pipe(
                tap((user) => {
    ...
    updateProfile(updateData: UpdateProfileRequest): Observable<User> {
        this.loadingSubject.next(true);
        return this.http.put<User>(`${this.API_URL}/users/profile`, updateData, { withCredentials: true })
            .pipe(
                tap((updatedUser) => {
    ...
    changePassword(passwordData: ChangePasswordRequest): Observable<any> {
        this.loadingSubject.next(true);
        return this.http.put(`${this.API_URL}/users/change-password`, passwordData, { withCredentials: true })
            .pipe(
                tap(() => this.loadingSubject.next(false)),
                catchError(error => {
                    this.loadingSubject.next(false);
    ...
    uploadAvatar(file: File): Observable<{ avatarUrl: string }> {
        ...
        return this.http.post<{ avatarUrl: string }>(`${this.API_URL}/users/upload-avatar`, formData, { withCredentials: true })
            .pipe(
                tap((response) => {
    ...
    followUser(userId: number): Observable<any> {
        return this.http.post(`${this.API_URL}/users/${userId}/follow`, {}, { withCredentials: true })
            .pipe(
                tap(() => {
    ...
    unfollowUser(userId: number): Observable<any> {
        return this.http.delete(`${this.API_URL}/users/${userId}/follow`, { withCredentials: true })
            .pipe(
                tap(() => {
                    // Refresh current user data to update following count
                    this.getCurrentUserProfile().subscribe();
    ...
    isFollowing(userId: number): Observable<boolean> {
        return this.http.get<boolean>(`${this.API_URL}/users/${userId}/is-following`, { withCredentials: true });
    }
